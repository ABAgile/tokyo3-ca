...
| # | Threat                                          | Mitigation                                                                                                                                                                                        |
|---|-------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1 | Brute force on Basic-auth                       | Constant-time compare (`auth.go`); no rate limiting in certd. Front with an edge that rate-limits 401s.                                                                                            |
